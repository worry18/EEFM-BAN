...
class SIDD(DenoiseDataSet):
    ...
    def _scan(self):
        ...
        for folder_name in os.listdir(dataset_path):
            # folder_name:'0101_005_S6_00100_00050_4400_L'
            # parse folder name of each shot
            # parsed_name: {'scene_instance_number': '0101', 'scene_number': '005', 'smartphone_camera_code': 'S6', 'ISO_speed': '00100', 'shutter_speed': '00050', 'illuminant_temperature': '4400', 'illuminant_brightness_code': 'L'}
            parsed_name = self._parse_folder_name(folder_name)

            # add path & information of image 0
            info0 = {}
            # info0是一个字典存储：实例信息、干净图像路径、噪声图像路径
            ...
            # img_paths列表将存储数据集中所有图像的路径和相关信息
