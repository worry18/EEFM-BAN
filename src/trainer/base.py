...
class BaseTrainer():
    ...
    def test_img(self, image_dir, save_dir='./'):
        ...
        # denoised = cv2.GaussianBlur(denoised, (3, 3), 0)  # 输入张量是三个维度的
    ...
    def test_DND(self, img_save_path):
        ...
        denoise_srgb(wrap_denoiser, '/oldhome/wry/AP-BSN-master/dataset/DND/dnd_2017', self.file_manager.get_dir(img_save_path + '/mat'))
