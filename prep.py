...
def main():
    ...
    args.add_argument('-d', '--dataset',    default='SIDD_val',   type=str)
    args.add_argument('-s', '--patch_size', default=256,  type=int)
    # args.add_argument('-s', '--patch_size', default=256, type=int)
    args.add_argument('-o', '--overlap',    default=0,  type=int)
    # args.add_argument('-o', '--overlap', default=0, type=int)
